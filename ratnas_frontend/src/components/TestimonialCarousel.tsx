        ...
        <div className="relative">
          ...
          >
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="bg-white h-[95%] md:h-full rounded-2xl shadow-lg p-6 md:p-8 mx-auto max-w-4xl relative">
                  <Quote className="absolute top-6 left-6 h-8 w-8 text-rose-200" />

                  <div className="flex flex-col md:flex-row items-center md:items-start space-y-0 md:space-x-8 pt-2 md:pt-8">
                    <div className="flex-shrink-0">
                      <img
                        src={testimonial.image}
                        alt={testimonial.name}
                        className="w-10 h-10 md:w-20 md:h-20 rounded-full object-cover border-4 border-rose-100"
                      />
                    </div>
                    ...
                    <div className="flex-1 text-center md:text-left">
                      ...
                      <p className="text-gray-700 text-sm md:text-lg leading-relaxed mb-2 md:mb-6 italic">
                        <span className="block md:hidden line-clamp-1">
                          "{testimonial.text}"
                        </span>
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 text-sm md:text-lg">{testimonial.location}</p>
                      </div>
                    </div>
                  </div>
                </div>
